...
music=pg.mixer.music.load('Nagin.mp3')##
...
class snake():
    def __init__(self,speed, size):
        ...
        self.image.fill((255,255,255))#####000-255255255
        self.speed = speed
        self.size = size
        self.images = []
        self.old_pos = [[20,20]]
    ...
    def add_apple(self):
        ...
        block.fill((255,255,255))####02550-255255255
...
class startmenu():
    def __init__(self):
        self.screen = pg.display.set_mode((800,450))
        self.b1 = '(150, 300,100,50),"Start", [(50,255,100), (0,150,0)], action = self.start'
    ...
    def mainloop(self):
        while 1:
            self.screen.fill((0,0,0))######35-0##38-0##117-0
            
            self.make_text(400, 150, ('SNAKE GAME'),color = (255,255,255), size = 60, a = True)###size80-60
            self.make_text(725, 400, 'Rumil S24-121', color = (255,255,255),size=15,a=True)#
            self.make_text(725, 415, 'Yashvi S24-122', color = (255,255,255),size=15,a=True)#
            self.make_text(725, 430, 'Jahnvi S24-129', color = (255,255,255),size=15,a=True)#
            for event in pg.event.get():
                if event.type == pg.QUIT:
                    sys.exit()
            for x in self.blocks:
